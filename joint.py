...
class JOINT: 
    ...
    def __init__(self,name,parent,child,type,position,orientation):
    ...
    def Save(self,f):
        ...
        Save_Whitespace(self.depth,f)
        orienString = str(self.orientation[0]) + " " + str(self.orientation[1]) + " " + str(self.orientation[2])
        f.write('   <axis xyz="' + orienString + '"/>\n')
